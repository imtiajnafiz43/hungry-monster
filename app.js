    ...
    const displayFoods = foods => {
        ...
        if (foods != null) {
            foods.map(food => {
                ...
                const foodInfo = `
                                <div onclick="displayDetails('${food.idMeal}')" style="background-color:white; box-shadow: 3px 5px 10px 0px rgba(22, 21, 21, 0.15)" class="border rounded text-center h-100" data-bs-toggle="modal" data-bs-target="#exampleModal">
